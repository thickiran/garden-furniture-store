    ...
    <>
      ...
      <div className="min-h-screen" style={{backgroundColor: 'var(--color-surface)'}}>
        ...
        <div className="py-16" style={{backgroundColor: 'yellow', padding: '20px'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 style={{color: 'red', fontSize: '32px', fontWeight: 'bold', marginBottom: '20px'}}>🧪 SIMPLE IFRAME TEST 🧪</h1>
            
            <h2 style={{color: 'black', fontSize: '24px', marginBottom: '10px'}}>Your Exact Iframe Code AS IS</h2>
            ...
            {(() => {
              console.log('🧪 SIMPLE IFRAME TEST - EXACT CODE AS PROVIDED');
              console.log('🧪 Check network tab to see what requests are made');
              console.log('🧪 This is your exact iframe code with no modifications');
              return null;
            })()}
          </div>
        </div>
